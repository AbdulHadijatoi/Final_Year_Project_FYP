...
<div class="conatiner"><span class="numer">4</span>
  ...
  <div class="text-white fs-30-bold">This user profile is not available right now</div>
  <p class="text-white fs-20-bold">Sorry! We hope you will find this user one day!</p>
</div>
